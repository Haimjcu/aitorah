      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-white/10 pt-6 flex justify-between items-center text-xs text-white/40">
          ...
          <div className="flex gap-3">
            {[
              { title: 'X/Twitter', path: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z' },
              ...
              <Link key={s.title} href="/contact" title={s.title} className="w-8 h-8 rounded-md bg-white/7 flex items-center justify-center text-white/50 hover:bg-white/15 hover:text-white transition-all">
