        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-10">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 mb-3 text-white">
              ...
              <span className="font-serif text-lg">Torah</span>
            </div>
            ...
            <div className="flex flex-col gap-1 mt-3 text-xs text-white/40">
              <span>Powered by <a href="https://www.sefaria.org" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors underline underline-offset-2">Sefaria</a></span>
              <span>Powered by <a href="https://www.hebcal.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors underline underline-offset-2">Hebcal</a></span>
            </div>
          </div>
          {[
